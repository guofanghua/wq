...
public final class RegexpUtil {
	...
	// 匹配19位银行卡
	public static final String Bank_regexp = "[0-9]{19}";
	 ...
	 * 
	 */
	public static final String phone_regexp = "^0{0,1}(13[0-9]|15[0-9]|18[0-9])[0-9]{8}$";
	...
	// 身份证匹配
	public static final String ID_card_regexp1 = "/d{17}[/dxX]|/d{15}";
	/**
	 * 匹配邮编代码
	 * 
	 * 
