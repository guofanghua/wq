...
/** 带有截取框 */
public class ClipActivity2 extends Activity implements OnClickListener,
		OnTouchListener {
	...
	private final Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (!isBackFlag) {
				Intent intent = new Intent(ClipActivity2.this,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (bmpSoft == null) {
				Toast.makeText(ClipActivity2.this, "没有找到图片", 0).show();
				finish();
			} else {
	...
	private Bitmap getBitmap() {
		...
		finalBitmap = Bitmap.createBitmap(screenShoot, ClipView.width / 2
				- ClipView.SX + 1, ClipView.height / 2 - ClipView.SX
