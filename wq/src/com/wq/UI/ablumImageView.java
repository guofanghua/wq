...
public class ablumImageView extends ImageView {
	...
	private float scaleRate = 1;// 图片适应屏幕的缩放比例
	int screenWidth;
	int screenHeight;
	...
	public ablumImageView(Context context, int imageWidth, int imageHeight) {
		super(context);
	...
	public ablumImageView(Context context, AttributeSet attrs, int imageWidth,
			int imageHeight) {
		super(context, attrs);
		this.imageHeight = imageHeight;
		this.imageWidth = imageWidth;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		// 缩放到屏幕大小
		zoomTo(scaleRate, screenWidth, screenHeight);
	...
	public void layoutToCenter() {
		// 正在显示的图片实际宽高
		LoggerUtil.i("imagewidth=" + imageWidth + ",,,imageHeight="
				+ imageHeight);
		float width = imageWidth * getScale();
		float height = imageHeight * getScale();
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom = (float) (((screenWidth) / imageWidth)>1.0?1.0:0.5);
