...
import com.wq.Zxing.view.ViewfinderResultPointCallback;
...
//			activity.handleDecode((Result) message.obj, null);
		...
		case R.id.return_scan_result:
			...
			activity.finish();
			activity.overridePendingTransition(0, R.anim.show_transition_out_imm);
			break;
		}
	}
