...
/** 我的报告 */
public class workWDBGListAdapter extends BaseAdapter {
	...
	public workWDBGListAdapter(Context context, ArrayList<workRepModel> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.work_wdbg_list_item, null);
