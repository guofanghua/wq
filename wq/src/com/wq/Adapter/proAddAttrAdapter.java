...
public class proAddAttrAdapter extends BaseAdapter {
	...
	public proAddAttrAdapter(Context context, ArrayList<proAttr> list) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.pro_attr_show_item1, null);
