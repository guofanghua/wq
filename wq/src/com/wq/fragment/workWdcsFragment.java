...
import com.wq.Adapter.workWDCSListAdapter;
...
public class workWdcsFragment extends Fragment implements IXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.work_wdcs_fragement, container,
				false);
		initUI(v);
	...
	private void initUI(View v) {
		adapter = new workWDCSListAdapter(getActivity(), listModel);
	...
	private void httpData() {
		...
		params.put(httpUtil.WORK_LIST_TYPE, "2");
