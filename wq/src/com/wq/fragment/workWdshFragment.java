...
import com.wq.Adapter.workWDSHListAdapter;
 ...
 * 我的报告
 * */
public class workWdshFragment extends Fragment implements IXListViewListener {
	private XListView listview;
	ArrayList<workRepModel> listModel = new ArrayList<workRepModel>();
	workWDSHListAdapter adapter;
	// private ArrayList<partComModel> list = new ArrayList<partComModel>();
	public boolean isUpdate = true;// 用于标示，发送广播来时，是都需要加载数据

	public static final String BRO_ACTION_NAME = "com.wq.fragment.wdsh";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.work_wdsh_fragement, container,
				false);
	...
	private void initUI(View v) {
		adapter = new workWDSHListAdapter(getActivity(), listModel);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				LoggerUtil.i(position + "="
						+ listModel.get(position - 1).getId());
	...
	private void httpData() {
		...
		params.put(httpUtil.WORK_LIST_TYPE, "1");
